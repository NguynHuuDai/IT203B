...
public class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    System.out.println("Chon nut (so): ");
                    int slot = sc.nextInt();
                    ...
                    if (cmd == 1) command = new LightOnCommand(light);
                    else if (cmd == 2) command = new LightOffCommand(light);
                    else if (cmd == 3) command = new FanOnCommand(fan);
                    else if (cmd == 4) command = new FanOffCommand(fan);
                    else if (cmd == 5) {
