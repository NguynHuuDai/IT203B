...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List<User> users = List.of(
                ...
                new User("U02","b@gmail.com","123",false, LocalDate.of(2023,5,1)),
                new User("U03","c@gmail.com","123",true, LocalDate.of(2022,3,20)),
                new User("U04","d@gmail.com","123",true, LocalDate.of(2024,1,1)),
                new User("U05","e@gmail.com","123",false, LocalDate.of(2021,6,15))
        );
